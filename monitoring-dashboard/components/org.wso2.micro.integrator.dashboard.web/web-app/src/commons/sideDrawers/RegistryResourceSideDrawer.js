...
export default function RegistryResourceSideDrawer(props) {
    const { data, retrieveData,registryPath } = props;
            ...
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    ...
                    <RegistrySourceViewSection
                        ...
                        artifactType="registry-resources" registryName={registryName} registryPath={registryPath} data={data}/>
                </Grid>
            </Grid>
        </div>
    );
...
function RegistryResourceDetailPage(props) {
    const { data } = props;
    const registryName = data.childName
    const pageId = "registry-resources";
    return <Table>
        <TableRow>
